...
function About() {
    ...
    return (
        <section className="about pt-5">
            ...
            <div className="container about-body mt-5">

                <div className="mx-auto">
                    <h1 className="pt-5 text-center display-2 fw-normal" >About Me</h1>
                    ...
                    <div className="mt-5 p-5 row">
                        ...
                        <div className="col-md-6">
                            <img src={img} className="img-fluid rounded-3" style={{ width: "500px", height: "550px"}} />
                        </div>
                    </div>
                </div>
